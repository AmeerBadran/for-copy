...
export default function ContactForm() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-5 grid grid-cols-2 my-20">
      ...
      <div>
        <div className="bg-gray-100 rounded-2xl shadow-xl shadow-gray-300 z-20">
          <div className="flex gap-4 items-center p-8 ">
            ...
            <p className="font-bold text-lg text-my-color flex items-center">
